                            ...
                            <td class="px-6 py-4 flex flex-wrap">
                                ...
                                <div class="flex flex-wrap items-center">
                                    <form action="{{ route('status_permohonan', $item->status_izin->id) }}" method="post">
                                        ...
                                        <button type="submit"
                                            class="text-white bg-emerald-600 hover:bg-emerald-700 focus:outline-none focus:ring-4 focus:ring-emerald-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-emerald-500 dark:hover:bg-emerald-600 dark:focus:ring-emerald-800">
                                            Setuju
                                        </button>
                                    </form>
                                    ...
                                    <form action="{{ route('status_permohonan', $item->status_izin->id) }}" method="post">
                                        ...
                                        <button type="submit"
                                            class="text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-red-500 dark:hover:bg-red-600 dark:focus:ring-red-900">
                                            Tolak
                                        </button>
                                    </form>
                                </div>
