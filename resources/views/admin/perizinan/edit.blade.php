@extends('layouts.admin',["title" => "Edit Syarat Perizinan"])
@section('content')
        ...
        <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
            <div class="title mb-4">
                <div class="flex flex-row gap-2">
                    ...
                    <h1 class="font-bold text-2xl">Edit Syarat Perizinan</h1>
            ...
            <form action="{{ route('perizinan.update',$data->id) }}" method="POST">
                ...
                <input value="{{ $data->nama_file }}" type="text" required name="nama_file" id="nama_file" placeholder="Masukan Nama Persyaratan File" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
