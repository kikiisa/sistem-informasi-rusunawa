@extends('layouts.admin',["title" => "Tambah Informasi Kamar"])
@section('content')
        ...
        <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
            <div class="title mb-4">
                <div class="flex flex-row gap-2">
                    ...
                    <h1 class="font-bold text-2xl">Tambah Informasi Kamar</h1>
                </div>
            </div>
            ...
            <form action="{{ route('kamar.store') }}" method="POST"
                ...
                <div>
                    ...
                    <input type="text" id="no_kamar" name="no_kamar" value="{{ old('no_kamar') }}"
                        ...
                        required
                        placeholder="Contoh: 101, 102, 103, dst"
                        >
                </div>
                <div>
                    <label for="lt_kamar" class="block mb-2 text-sm font-medium text-gray-700">Lantai Kamar</label>
                    <input placeholder="Contoh: 1, 2, 3, dst" type="text" id="lt_kamar" name="lt_kamar" value="{{ old('lt_kamar') }}"
                        class="block w-full p-2.5 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500"
                        required>
                </div>
                ...
                <div>
                    ...
                    <input placeholder="Contoh: AC, TV, dll" type="text" id="fasilitas" name="fasilitas" value="{{ old('fasilitas') }}"
                        class="block w-full p-2.5 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500"
                        required>
                </div>
                ...
                <div>
                    ...
                    <input placeholder="Contoh: 100000, 200000, dll" type="text" id="harga" name="harga" value="{{ old('harga') }}"
                        class="block w-full p-2.5 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500"
                        required>
                </div>
